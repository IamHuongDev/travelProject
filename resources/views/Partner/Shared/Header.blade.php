         ...
         <div class="iq-top-navbar">
            <div class="iq-navbar-custom">
               <div class="iq-sidebar-logo">
                  ...
                  <img src="/assets_partner/images/logo.gif" class="img-fluid" alt="">
               </div>
               <div class="iq-dark-logo">
                  <img src="/assets_partner/images/logo-dark.gif" class="img-fluid" alt="">
               </div>
                     <span>vito</span>
                     </a>
                  </div>
               ...
               <nav class="navbar navbar-expand-lg navbar-light p-0">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="navbar-nav ml-auto navbar-list">
                        <li class="nav-item">
                           <a class="search-toggle iq-waves-effect language-title" href="#"><img src="/assets_partner/images/small/flag-01.png" alt="img-flaf" class="img-fluid mr-1" style="height: 16px; width: 16px;" /> English <i class="ri-arrow-down-s-line"></i></a>
                           <div class="iq-sub-dropdown">
                              <a class="iq-sub-card" href="#"><img src="/assets_partner/images/small/flag-02.png" alt="img-flaf" class="img-fluid mr-2" />French</a>
                              <a class="iq-sub-card" href="#"><img src="/assets_partner/images/small/flag-03.png" alt="img-flaf" class="img-fluid mr-2" />Spanish</a>
                              <a class="iq-sub-card" href="#"><img src="/assets_partner/images/small/flag-04.png" alt="img-flaf" class="img-fluid mr-2" />Italian</a>
                              <a class="iq-sub-card" href="#"><img src="/assets_partner/images/small/flag-05.png" alt="img-flaf" class="img-fluid mr-2" />German</a>
                              <a class="iq-sub-card" href="#"><img src="/assets_partner/images/small/flag-06.png" alt="img-flaf" class="img-fluid mr-2" />Japanese</a>
                           </div>
                        </li>
                        <li class="nav-item">
                                 ...
                                 <div class="iq-card-body p-0 ">
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="/assets_partner/images/user/01.jpg" alt="">
                                          </div>
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="/assets_partner/images/user/02.jpg" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="/assets_partner/images/user/03.jpg" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="/assets_partner/images/user/04.jpg" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                              ...
                              <div class="iq-card shadow-none m-0">
                                 <div class="iq-card-body p-0 ">
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="/assets_partner/images/user/05.jpg" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                  ...
                  <ul class="navbar-list">
                     <li>
                        <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center bg-primary rounded">
                           <img src="/assets_partner/images/user/1.jpg" class="img-fluid rounded mr-3" alt="user">
                           <div class="caption">
                           ...
                           <div class="iq-card shadow-none m-0">
                              <div class="iq-card-body p-0 ">
                                 ...
                                 <div class="d-inline-block w-100 text-center p-3">
                                    <a class="btn btn-primary dark-btn-primary" href="/partner/logout" role="button">Sign out<i class="ri-login-box-line ml-2"></i></a>
                                 </div>
                              </div>
                           </div>
                        </div>
