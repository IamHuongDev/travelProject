             ...
             <div class="iq-card-body">
                <div class="m-auto d-block text-center pb-3">
                   <div class="iq-user mb-3">
                      <img class="avatar-70 rounded-circle" src="/assets_partner/images/user/03.jpg" alt="">
                   </div>
                ...
                <ul class="d-flex align-items-center list-inline p-0 m-0 text-center">
                   <li class="col-md-4">
                      <div class="iq-user mb-3">
                         <img class="avatar-70 rounded-circle" src="/assets_partner/images/user/04.jpg" alt="">
                      </div>
                   ...
                   <li class="col-md-4">
                      <div class="iq-user mb-3">
                         <img class="avatar-70 rounded-circle" src="/assets_partner/images/user/05.jpg" alt="">
                      </div>
                   ...
                   <li class="col-md-4">
                      <div class="iq-user mb-3">
                         <img class="avatar-70 rounded-circle" src="/assets_partner/images/user/07.jpg" alt="">
                      </div>
       ...
       <div class="col-lg-5">
             ...
             <div class="iq-card-body p-3">
                <div class="d-flex align-items-center">
                   <div class="user-img img-fluid">
                      <img src="/assets_partner/images/user/01.jpg" alt="story-img" class="img-fluid rounded-circle avatar-40">
                   </div>
          ...
          <div class="iq-card iq-card-block iq-card-stretch mb-3">
             <div class="iq-card-body p-3">
                <div class="d-flex align-items-center">
                   <div class="user-img img-fluid">
                      <img src="/assets_partner/images/user/02.jpg" alt="story-img" class="img-fluid rounded-circle avatar-40">
                   </div>
                   <div class="media-support-info ml-3">
                      <h6>Anna Mull</h6>
          ...
          <div class="iq-card iq-card-block iq-card-stretch mb-3">
             <div class="iq-card-body p-3">
                <div class="d-flex align-items-center">
                   <div class="user-img img-fluid">
                      <img src="/assets_partner/images/user/03.jpg" alt="story-img" class="img-fluid rounded-circle avatar-40">
                   </div>
                   <div class="media-support-info ml-3">
                      <h6>Alex john</h6>
          ...
          <div class="iq-card iq-card-block iq-card-stretch mb-3">
             <div class="iq-card-body p-3">
                <div class="d-flex align-items-center">
                   <div class="user-img img-fluid">
                      <img src="/assets_partner/images/user/04.jpg" alt="story-img" class="img-fluid rounded-circle avatar-40">
                   </div>
                   <div class="media-support-info ml-3">
                      <h6>Cliff Hanger</h6>
          ...
          <div class="iq-card iq-card-block iq-card-stretch">
             <div class="iq-card-body p-3">
                <div class="d-flex align-items-center">
                   <div class="user-img img-fluid">
                      <img src="/assets_partner/images/user/05.jpg" alt="story-img" class="img-fluid rounded-circle avatar-40">
                   </div>
                   <div class="media-support-info ml-3">
                      <h6>Joe Shestak</h6>
                      ...
                      <tbody>
                         <tr>
                            <td class="text-center">
                               <img class="rounded-circle img-fluid avatar-40" src="/assets_partner/images/user/01.jpg" alt="profile">
                            </td>
                            <td>
                               <h6>Retail Int</h6>
