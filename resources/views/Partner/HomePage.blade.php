                    ...
                    <div class="iq-card-body">
                        <div class="m-auto d-block text-center pb-3">
                            <div class="iq-user mb-3">
                                <img class="avatar-70 rounded-circle" src="/assets_partner/images/user/03.jpg"
                                    alt="">
                            </div>
                        ...
                        <ul class="d-flex align-items-center list-inline p-0 m-0 text-center">
                            <li class="col-md-4">
                                <div class="iq-user mb-3">
                                    <img class="avatar-70 rounded-circle" src="/assets_partner/images/user/04.jpg"
                                        alt="">
                                </div>
                            ...
                            <li class="col-md-4">
                                <div class="iq-user mb-3">
                                    <img class="avatar-70 rounded-circle" src="/assets_partner/images/user/05.jpg"
                                        alt="">
                                </div>
                            ...
                            <li class="col-md-4">
                                <div class="iq-user mb-3">
                                    <img class="avatar-70 rounded-circle" src="/assets_partner/images/user/07.jpg"
                                        alt="">
                                </div>
            ...
            <div class="col-lg-5">
                    ...
                    <div class="iq-card-body p-3">
                        <div class="d-flex align-items-center">
                            <div class="user-img img-fluid">
                                <img src="/assets_partner/images/user/01.jpg" alt="story-img"
                ...
                <div class="iq-card iq-card-block iq-card-stretch mb-3">
                    <div class="iq-card-body p-3">
                        <div class="d-flex align-items-center">
                            <div class="user-img img-fluid">
                                <img src="/assets_partner/images/user/02.jpg" alt="story-img"
                                    class="img-fluid rounded-circle avatar-40">
                            </div>
                            <div class="media-support-info ml-3">
                                <h6>Anna Mull</h6>
                ...
                <div class="iq-card iq-card-block iq-card-stretch mb-3">
                    <div class="iq-card-body p-3">
                        <div class="d-flex align-items-center">
                            <div class="user-img img-fluid">
                                <img src="/assets_partner/images/user/03.jpg" alt="story-img"
                                    class="img-fluid rounded-circle avatar-40">
                            </div>
                            <div class="media-support-info ml-3">
                                <h6>Alex john</h6>
                ...
                <div class="iq-card iq-card-block iq-card-stretch mb-3">
                    <div class="iq-card-body p-3">
                        <div class="d-flex align-items-center">
                            <div class="user-img img-fluid">
                                <img src="/assets_partner/images/user/04.jpg" alt="story-img"
                                    class="img-fluid rounded-circle avatar-40">
                            </div>
                            <div class="media-support-info ml-3">
                                <h6>Cliff Hanger</h6>
                ...
                <div class="iq-card iq-card-block iq-card-stretch">
                    <div class="iq-card-body p-3">
                        <div class="d-flex align-items-center">
                            <div class="user-img img-fluid">
                                <img src="/assets_partner/images/user/05.jpg" alt="story-img"
                                    class="img-fluid rounded-circle avatar-40">
                            </div>
                            <div class="media-support-info ml-3">
                                <h6>Joe Shestak</h6>
            ...
            <div class="col-lg-12">
                <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                    <div class="iq-card-header d-flex justify-content-between">
                        ...
                        <div class="iq-card-header-toolbar d-flex align-items-center">
                            <div class="dropdown">
                                <span class="dropdown-toggle dropdown-bg dark-icon-light iq-bg-primary"
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow-none"
                                    ...
                                    style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(391px, 30px, 0px);">
                                    <a class="dropdown-item" href="#"><i class="ri-eye-fill mr-2"></i>View</a>
                                    <a class="dropdown-item" href="#"><i
                                            class="ri-delete-bin-6-fill mr-2"></i>Delete</a>
                                    <a class="dropdown-item" href="#"><i class="ri-pencil-fill mr-2"></i>Edit</a>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <img class="rounded-circle img-fluid avatar-40"
                                                src="/assets_partner/images/user/01.jpg" alt="profile">
                                        </td>
                                        <td>
                                            <h6>Retail Int</h6>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center justify-content-end">
                                                <a href="javascript:void();"
                                                    class="avatar-45 text-center ml-3 rounded-circle iq-bg-success font-size-18"><i
                                                        class="ri-pencil-fill font-size-16"></i></a>
                                                <a href="javascript:void();"
                                                    class="avatar-45 rounded-circle text-center ml-3 iq-bg-danger font-size-18"><i
                                                        class="ri-delete-bin-line font-size-16"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
